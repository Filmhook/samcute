...
export default function MyActivities() {
    ...
    return (
        ...
        <View>
            ...
            <View style={{ flexDirection: "row",padding:responsiveWidth(1), alignItems: 'center' }}>
                ...
                <View>
                    <TouchableOpacity
                        ...
                        <Image source={require('../../../Assets/app_logo/8641606.jpg')}
                ...
                <View style={{ flexDirection: 'row', columnGapL: responsiveWidth(3), left: responsiveWidth(8) }}>

                    <Text style={{ fontSize: responsiveFontSize(2), fontWeight: 'bold', color: 'black' }}> 2d</Text>
                    <View style={{ height: responsiveHeight(4), width: responsiveWidth(8), left: responsiveWidth(2) }}>
                        <Image source={require('../../../Assets/Home_Icon_And_Fonts/lock_icon.png')} style={{ height: responsiveHeight(3), width: responsiveWidth(4.5) }} />
                    </View>
                    <Text style={{ fontSize: responsiveFontSize(2), fontWeight: 'bold', color: 'black' }}> 216K</Text>
                </View>
                <View style={{ height: responsiveHeight(4), width: responsiveWidth(8), left: responsiveWidth(10) }}>

                    <Image source={require('../../../Assets/Home_Icon_And_Fonts/see_more_icon.png')}
            ...
            <View style={{ left: responsiveWidth(1) }}>
                <Text style={{ fontSize: responsiveFontSize(1.7) }}>
                    It is a long established fact that a reader will be distracted by the the the  readable content of a page when looking at its layout.It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
                </Text>
            </View>
            <View
                style={{ borderColor: "grey", width: responsiveWidth(100), height: responsiveHeight(50), }}>
                <Image source={require('../../../Assets/app_logo/8641612.jpg')}
                    style={{ width: "100%", height: '100%' }} />
            </View>

            <View
                style={{ height: responsiveHeight(7), width: responsiveWidth(98), flexDirection: "row", justifyContent: "space-between", top: responsiveHeight(0.5) }}>
                <View>
                    ...
                    <TouchableOpacity
                        //  {`${formatCmpctNumber(like)} Likes`}
                        onPress={() => onLikePress(id)}
                        style={{ width: responsiveWidth(20), height: responsiveHeight(3.6), borderWidth: 1, borderRadius: responsiveWidth(2), flexDirection: "row", justifyContent: 'center', alignItems: 'center' }}>
                        <View
                            style={{ width: responsiveWidth(6), height: responsiveHeight(2.5), right: responsiveWidth(2) }}>
                            {hitlike && hitlike ?
                                <Image source={require('../../../Assets/Home_Icon_And_Fonts/Like_after_Icon.png')} style={{ width: "100%", height: "95%", }} />
                        ...
                        <Text
                            style={{ alignSelf: "center", fontWeight: "500", color: "#000000" }}>Like</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View >
                    <Text
                        style={{ textAlign: "center", fontWeight: "500", fontSize: responsiveFontSize(1.4), fontWeight: "500", color: "#000000" }}>{`${formatCmpctNumber(comments.length)} comments`}</Text>
                    <TouchableOpacity
                        onPress={() => onCommentPress(id)}
                        style={{ width: responsiveWidth(28), height: responsiveHeight(3.6), borderWidth: 1, borderRadius: responsiveWidth(2), flexDirection: "row", justifyContent: 'center', alignItems: 'center' }}>
                        <View
                            style={{ width: responsiveWidth(6), height: responsiveHeight(2.5), right: responsiveWidth(1) }}>
                            <Image source={require('../../../Assets/Home_Icon_And_Fonts/comment.png')}
                                style={{ width: "100%", height: "100%" }}
                        ...
                        <Text
                            style={{ alignSelf: "center", fontWeight: "500", color: "#000000" }}>Comments</Text>
                    </TouchableOpacity>
                </View>

                {/* shares button */}
                <View>
                    <Text style={{ textAlign: "center", fontWeight: "500", fontSize: responsiveFontSize(1.4), fontWeight: "500", color: "#000000" }}>0 Share</Text>
                    <TouchableOpacity
                        onPress={() => onSharePress(id)}
                        style={{ width: responsiveWidth(20), height: responsiveHeight(3.6), borderWidth: 1, borderRadius: responsiveWidth(2), flexDirection: "row", justifyContent: 'center', alignItems: 'center' }}>
                        <View
                        ...
                        <Text
                            style={{ alignSelf: "center", fontWeight: "500", color: "#000000" }}>Share</Text>
                    </TouchableOpacity>
                </View>
            </View>
