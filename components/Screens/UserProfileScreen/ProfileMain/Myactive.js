                  ...
                  {view_type === 'public' ?
                    ...
                    <Image source={require('../../../components/Assets/Home_Icon_And_Fonts/public_earth.png')} style={{ width: "90%", height: '90%' }} resizeMode='stretch' />
                        ...
                        <View
                            ...
                            <View >
                                <Text
                                    style={{ textAlign: "center", fontWeight: "500", fontSize: responsiveFontSize(1.4), fontWeight: "500", color: "#000000", left: responsiveWidth(2) }}>{`${formatCmpctNumber(comments.length)} comments`}</Text>
                                <TouchableOpacity
                            ...
                            {/* shares button */}
                            <View>
                                <Text style={{ textAlign: "center", fontWeight: "500", fontSize: responsiveFontSize(1.4), fontWeight: "500", color: "#000000", left: responsiveWidth(4) }}>0 Share</Text>
                                <TouchableOpacity
