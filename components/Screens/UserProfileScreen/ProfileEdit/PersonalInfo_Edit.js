...
export default function Personalinfo_edit() {
  ...
  const navigateData = async () => {
    try {
      ...
      await axios.put('http://10.0.2.2:8000/user/', {
        ...
        {personalInfovisible && (
          <View style={{ marginTop: 10 }}>
            ...
            <SelectList
              ...
              boxStyles={{ marginBottom: 20, width: 300, marginLeft: 40, borderColor: "black" }}
              dropdownStyles={{ width: 300, marginLeft: 40, marginBottom: 10, marginTop: -10 }}
            ...
            <TextInput
              ...
              placeholder='Enter Your Caste' value={caste}
            />
            ...
            <TouchableOpacity style={{
              ...
              <Text style={{ color: 'white' }} onPress={navigateData}>SAVE</Text>
            </TouchableOpacity>
          </View>
        )}
