...
export default function Forgetpass() {
  ...
  const handleSendOTP = () => {
    ...
    setTimeout(() => {
      // After a delay, set the OTP value to a dummy OTP
  ...
  const handleVerify = () => {
    ...
    Alert.alert('OTP Verified', 'Your OTP has been verified successfully.', [
      {
        text: 'OK',
        onPress: () => navigation.navigate('ForgotPasswordsecondpage')
      }
    ]);
  };
        ...
        <View style={styles.formContainer}>
          ...
          {isSendClicked && (
            <>
              ...
              <TouchableOpacity style={styles.boxContent1} onPress={()=>navigation.navigate('ForgotPasswordsecondpage')}>
                {/* <ImageBackground style={styles.inputContainer1} source={require('../../../Assets/Login_page/Medium_B_User_Profile.png')} resizeMode="stretch" > */}
