...
//       setItems((prevItems) => [
//         ...prevItems,
//         { id: prevItems.length + 1, text: inputText },
//       ]);
//       setInputText('');
//     }
//   };
...
//       >
//         <Text style={{ color: 'white', fontWeight: 'bold', textAlign: 'center', padding: 10 }}>Next</Text>
//         </TouchableOpacity>
//         </View>
//         <View>
//         <TouchableOpacity
...
//         </TouchableOpacity>
//         </View>
//         <View style={{ borderWidth: 3, borderRadius: 10, margin: 5, borderColor: 'blue', backgroundColor: 'white', top: 120, overflow: 'scroll', paddingBottom: 50, shadowColor: '#080504', shadowOffset: { width: -2, height: 40 }, shadowOpacity: 0.2, shadowRadius: 50, elevation: 200 }}>
//         <Text style={{ fontSize: 18, fontWeight: 'bold', alignSelf: 'center' }}>A Little More</Text>
//         <View style={{ borderWidth: 1, borderRadius: 10, margin: 5, top: 10 }}>
//           <TextInput
//             multiline
//             maxLength={200}
...
//         <TouchableOpacity
//           onPress={addItem}
//           style={{ backgroundColor: 'blue', borderRadius: 10, margin: 5, top: 10 }}>
//           <Text style={{ color: 'white', fontWeight: 'bold', textAlign: 'center', padding: 10 }}>
//             Add to List
//           </Text>
//         </TouchableOpacity>
//         <View style={{ borderWidth: 1, borderRadius: 10, top: 10, margin: 5 }}>
