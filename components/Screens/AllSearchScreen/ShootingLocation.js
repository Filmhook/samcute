                            ...
                            <View style={styles.itemContainer}>
                                ...
                                <View style={styles.itemContainerDetials}>
                                    ...
                                    <View style={{ flexDirection: 'row', columnGap: responsiveWidth(5) }}>
                                        <Text style={{ width: responsiveWidth(20), height: responsiveHeight(3), borderRadius: responsiveWidth(2), backgroundColor: '#616161', textAlign: 'center', textAlignVertical: 'center', marginTop: responsiveHeight(1), color: 'white', fontWeight: '800' }}>₹{item.cost}k/{item.hourMonthDay}</Text>
