...
// export default function Storycontainor() {
...
//     setStory([...story, { ...image, name: 'Mystatus', profession: 'Actor' }]);
...
//                 />
//               </TouchableOpacity>
//               <View style={{ left: responsiveWidth(7.5), width: responsiveWidth(13.7), top: responsiveHeight(-3)}}>
//                 <Text
//                   numberOfLines={1}
//                   style={{ fontSize: responsiveFontSize(1.4), fontWeight: '600', color: '#000000' }}>
//                   {name}
//                 </Text>

//                 <Text
//                   numberOfLines={1}
//                   style={{ fontSize: responsiveFontSize(1), fontWeight: '600', color: '#000000' }}>
//                   {profession}
//                 </Text>
//               </View>
//             </View>
